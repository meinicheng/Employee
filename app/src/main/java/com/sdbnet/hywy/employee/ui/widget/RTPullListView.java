...
public class RTPullListView extends ListView implements OnScrollListener {
	...
	private OnAutoLoadingListener autoLoadingListener;
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.pull_list_head, null);
	...
	public void onScrollStateChanged(AbsListView arg0, int scrollState) {
		int lastIndex = arg0.getCount() - 1; // 加上底部的loadMoreView项
		if (isAutoLoading) {
	...
	public void setonAutoLoadingListener(OnAutoLoadingListener autoLoadingListener) {
		this.autoLoadingListener = autoLoadingListener;
		isAutoLoading = true;
	}
	...
	public interface OnAutoLoadingListener {
	...
	private void onAutoLoading() {
		if (autoLoadingListener != null) {
			autoLoadingListener.onAutoLoading();
		}
	}
